...
"""
"""
##### Draw a line chart: You can easily add a line chart to your app with st.line_chart(). We'll generate a random sample using Numpy and then chart it.
"""
import streamlit as st
import numpy as np
import pandas as pd
...
"""
#####  Plot a map: With st.map() you can display data points on a map. Let's use Numpy to generate some sample data and plot it on a map of San Francisco.
"""
import streamlit as st
import numpy as np
import pandas as pd
...
"""
#####  Widgets: When you've got the data or model into the state that you want to explore, you can add in widgets like st.slider(), st.button() or st.selectbox(). It's really straightforward — treat widgets as variables:
"""
import streamlit as st
...
"""
#####  Use checkboxes to show/hide data: One use case for checkboxes is to hide or show a specific chart or section in an app. st.checkbox() takes a single argument, which is the widget label. In this sample, the checkbox is used to toggle a conditional statement.
"""
import streamlit as st
import numpy as np
import pandas as pd
